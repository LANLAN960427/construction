<template>
  <div class="proquery">
    ...
    <div class="pro-label">
      <!-- 项目概况 -->
      <van-collapse v-model="activeNamesfour">
        <van-collapse-item class="itemData" title="项目概况">
          <van-cell-group>
            ...
            <van-field v-model="queryData.prj_info.prj_lx" label="联系人和联系电话：" disabled />
            <van-field v-model="queryData.prj_info.prj_yw" label="业务员：" disabled />
            <van-field v-model="queryData.prj_info.prj_tel" label="联系电话：" disabled />
            <van-field v-model="queryData.prj_info.prj_reg_d" label="登记日期：" disabled />
            <van-field v-model="queryData.prj_info.prj_ht" label="合同情况：" disabled />
            <van-field v-model="queryData.prj_info.prj_jf" label="缴费情况：" disabled />
            <van-field v-model="queryData.prj_info.prj_xkz" label="项目许可证：" disabled />
            <van-field v-model="queryData.prj_info.prj_xk_d" label="取得时间：" disabled />
            <van-field v-model="queryData.prj_info.prj_hgz_d" label="合格证时间：" disabled />
            <van-field v-model="queryData.prj_info.prj_hgz_no" label="合格证编号：" disabled />
            <van-field v-model="queryData.prj_info.prj_xkz_gh" label="工程规划许可证：" disabled />
          </van-cell-group>
        </van-collapse-item>
      </van-collapse>
    </div>
          ...
          <div class="pro-card">
            <div class="pro-item">
              <van-collapse v-model="activeNamestwo">
                <van-collapse-item class="vanData" title="审查情况">
                  <!-- :name="index" -->
          ...
          <div class="pro-card">
            <div class="pro-item">
              <van-collapse v-model="activeNamesthree">
                <van-collapse-item class="vanData" title="强条">
                  <!-- :name="index" -->
          ...
          <div class="pro-card">
            <div class="pro-item">
              <van-collapse v-model="activeNames">
                <van-collapse-item class="vanData" title="勘察设计人员备案信息">
                  <!-- :name="index" -->
...
export default {
  data() {
    return {
      ...
      activeNamesfour: [0, 1, 2, 3, 4, 5, 6, 7]
    };
  },
  computed,
  methods: {},
